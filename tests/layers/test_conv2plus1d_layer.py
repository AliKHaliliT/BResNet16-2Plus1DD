import unittest
from BResNet162Plus1DD.assets.layers.conv2plus1d_layer import Conv2Plus1DLayer
import tensorflow as tf
import inspect


class TestConv2Plus1DLayer(unittest.TestCase):
    ...
    def test_filters_wrong__value_value__error(self):
        ...
        with self.assertRaises(ValueError):
            Conv2Plus1DLayer(filters=filters, kernel_size=(1, 1, 1), strides=(1, 1, 1), 
                             padding="same")
    ...
    def test_kernel__size_wrong__value_value__error(self):
        ...
        # Act and Assert
        with self.assertRaises(ValueError):
            Conv2Plus1DLayer(filters=1, kernel_size=kernel_size, strides=(1, 1, 1), 
                             padding="same")
    ...
    def test_strides_wrong__value_value__error(self):
        ...
        # Act and Assert
        with self.assertRaises(ValueError):
            Conv2Plus1DLayer(filters=1, kernel_size=(1, 1, 1), strides=strides, 
                             padding="same")
    ...
    def test_padding_wrong__value_value__error(self):
        ...
        # Act and Assert
        with self.assertRaises(ValueError):
            Conv2Plus1DLayer(filters=1, kernel_size=(1, 1, 1), strides=(1, 1, 1), 
                             padding=padding)
    ...
    def test_creation_init_layer(self):
        ...
        # Arrange and Act
        layer = Conv2Plus1DLayer(filters=1, kernel_size=(1, 1, 1), strides=(1, 1, 1), 
                                 padding="same")
    ...
    def test_output_tensor_intended__shape(self):
        ...
        # Act
        output = Conv2Plus1DLayer(filters=1, kernel_size=(1, 1, 1), strides=(1, 1, 1), 
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(Conv2Plus1DLayer.__init__).parameters.values()
